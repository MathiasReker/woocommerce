...
class WC_Product_Variable_Data_Store_CPT_Test extends WC_Unit_Test_Case {
	...
	public function test_variation_price_cache_vat_exempt() {
		...
		add_filter( 'pre_option_woocommerce_tax_display_shop', [ $this, '__return_incl' ] );
		add_filter( 'pre_option_woocommerce_tax_display_cart', [ $this, '__return_incl' ] );
		...
		$prices_no_tax    = [ '9.09', '13.64', '14.55', '15.45', '16.36', '17.27' ];
		...
		$prices_with_tax  = [ '10.00', '15.00', '16.00', '17.00', '18.00', '19.00' ];
		$variation_prices = $product->get_variation_prices( true );
