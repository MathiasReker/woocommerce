...
class WC_Tests_API_Orders extends WC_REST_Unit_Test_Case {
	...
	public function test_get_item_with_variation_parent_name() {
		...
		$this->assertTrue(   str_contains( $last_line_item['name'], $variation->get_attribute( 'pa_size' ) ) );
		...
		$this->assertTrue(   !str_contains( $last_line_item['parent_name'], $variation->get_attribute( 'pa_size' ) ) );
	}
