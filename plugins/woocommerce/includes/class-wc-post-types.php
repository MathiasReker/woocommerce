...
class WC_Post_Types {
	...
	public static function init() {
		...
		add_action( 'woocommerce_after_register_post_type', [ __CLASS__, 'maybe_flush_rewrite_rules' ] );
		add_action( 'woocommerce_flush_rewrite_rules', [ __CLASS__, 'flush_rewrite_rules' ] );
	...
	public static function register_taxonomies() {
		...
		register_taxonomy(
			'product_visibility',
			apply_filters( 'woocommerce_taxonomy_objects_product_visibility', [ 'product', 'product_variation' ] ),
			apply_filters(
		...
		register_taxonomy(
			...
			apply_filters( 'woocommerce_taxonomy_objects_product_shipping_class', [ 'product', 'product_variation' ] ),
			apply_filters(
	...
	public static function register_post_types() {
		...
		$permalinks = wc_get_permalink_structure();
		$supports   = [ 'title', 'editor', 'excerpt', 'thumbnail', 'custom-fields', 'publicize', 'wpcom-markdown' ];
