...
<div id="general_product_data" class="panel woocommerce_options_panel">
	...
	<div class="options_group show_if_external">
		...
		woocommerce_wp_text_input(
			[
				'id'          => '_product_url',
				'value'       => is_callable( [ $product_object, 'get_product_url' ] ) ? $product_object->get_product_url( 'edit' ) : '',
		...
		woocommerce_wp_text_input(
			[
				'id'          => '_button_text',
				'value'       => is_callable( [ $product_object, 'get_button_text' ] ) ? $product_object->get_button_text( 'edit' ) : '',
